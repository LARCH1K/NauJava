package ru.nikita.naujava.processors;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import ru.nikita.naujava.entities.Homework;
import ru.nikita.naujava.services.HomeworkService;
            ...
            switch (cmd[0]) {
                ...
                case "read" -> {
                    ...
                    if (homework != null) {
                        ...
                        System.out.println("Домашняя работа не найдена...");
                    }
                }
                ...
                case "delete" -> {
                    ...
                    System.out.println("Домашняя работа успешно удалена...");
                }
