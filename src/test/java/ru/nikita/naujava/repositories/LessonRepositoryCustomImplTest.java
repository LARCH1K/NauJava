...
import ru.nikita.naujava.dao.LessonRepositoryCustomImpl;
...
@SpringBootTest
public class LessonRepositoryCustomImplTest {

    private final LessonRepository lessonRepository;

    private final HomeworkRepository homeworkRepository;

    private final LessonRepositoryCustomImpl lessonRepositoryCustomImpl;

    @Autowired
    public LessonRepositoryCustomImplTest(LessonRepository lessonRepository, HomeworkRepository homeworkRepository,
                                          LessonRepositoryCustomImpl lessonRepositoryCustomImpl) {
        this.lessonRepository = lessonRepository;
        this.homeworkRepository = homeworkRepository;
        this.lessonRepositoryCustomImpl = lessonRepositoryCustomImpl;
    }
    ...
    void testGetLessonsWhereMarkInHomeworkMoreThanThree() {
        List<Lesson> lessons = lessonRepositoryCustomImpl.getLessonsWhereMarkInHomeworkMoreThanThree();
